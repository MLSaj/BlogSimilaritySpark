...
import user.{UserEvent,UserVector}
...
def main(args: Array[String]): Unit = {
  ...
  val event1: UserEvent = UserEvent(1, "Blog1")
  val event2: UserEvent = UserEvent(1, "Blog2")
  ...
  val visits_array: Seq[String] = Seq("Blog1","Blog2","Blog3")
